  ...
  function (Component, Button, Label, VerticalList, Carousel, DataSource, SimpleFormatter, SimpleFeed) {
    ...
    return Component.extend({
      init: function init () {
        ...
        helloWorldLabel = new Label("helloWorldLabel", "LOGITUIT");
        this.appendChildWidget(helloWorldLabel);

        welcomeLabel = new Label("welcomeLabel", "Carousel Assignment");
      ...
      _createCarouselButton: function () {
        ...
        button.appendChildWidget(new Label("Movies List"));
      ...
      _getCarouselConfig: function () {
        return {
          description: "BLOCK BUSTER MOVIES LIST",
